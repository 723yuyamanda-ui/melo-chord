    ...
    <div className="h-full w-full bg-gradient-to-b from-gray-950 via-gray-950 to-indigo-950/30 text-white flex flex-col items-center justify-center p-6 lg:p-12 select-none relative overflow-y-auto lg:overflow-hidden">
      ...
      <div className="absolute top-4 right-4 lg:top-6 lg:right-6 flex items-center gap-2 lg:gap-3 z-50">
        <button 
          ...
          className="p-2 lg:px-3 lg:py-2 bg-gray-900/80 hover:bg-gray-800 border border-gray-800 rounded-xl text-gray-300 hover:text-white transition-all flex items-center gap-1.5 text-xs font-bold relative"
        >
        ...
        <button 
          ...
          className="p-2 lg:px-3 lg:py-2 bg-gray-900/80 hover:bg-gray-800 border border-gray-800 rounded-xl text-gray-300 hover:text-white transition-all flex items-center gap-1.5 text-xs font-bold"
        >
      ...
      {/* ─── メインカードコンテナ (PC時: センターレイアウトカード化) ─── */}
      <div className="w-full max-w-sm lg:max-w-md bg-transparent lg:bg-gray-900/40 lg:backdrop-blur-xl lg:border lg:border-gray-800/80 lg:p-10 lg:rounded-3xl lg:shadow-2xl flex flex-col items-center my-auto">
        ...
        <div className="w-full flex flex-col gap-3.5 z-10">
          <button 
            ...
            className="w-full py-4 lg:py-4.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 rounded-2xl font-black text-sm lg:text-base flex items-center justify-center gap-2 transition-all active:scale-[0.98] shadow-lg shadow-blue-600/20 text-white"
          >
          ...
          <button 
            ...
            className="w-full py-4 lg:py-4.5 bg-gradient-to-r from-teal-600 to-emerald-600 hover:from-teal-500 hover:to-emerald-500 rounded-2xl font-black text-sm lg:text-base flex items-center justify-center gap-2 transition-all active:scale-[0.98] shadow-lg shadow-teal-600/20 text-white"
          >
            <Sparkles size={18} />
            <span>デモ曲で試す</span>
          </button>
          ...
          <button 
            ...
            className="w-full py-4 lg:py-4.5 bg-gray-900/80 hover:bg-gray-800/80 border border-gray-800 rounded-2xl font-bold text-sm lg:text-base flex items-center justify-center gap-2 transition-all active:scale-[0.98]"
          >
      ...
      {isNewsOpen && (
        <div className="absolute inset-0 bg-black/80 backdrop-blur-md z-[120] flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="w-full max-w-[390px] lg:max-w-md bg-gray-900 border border-gray-800 rounded-3xl p-5 lg:p-6 flex flex-col shadow-2xl relative max-h-[85vh]">
            <button 
            ...
            <div className="flex-1 overflow-y-auto flex flex-col gap-3 scrollbar-none my-1 pr-1">
              {NEWS_ITEMS.slice(0, 3).map((item) => (
                <div key={item.id} className="p-3.5 bg-gray-950 border border-gray-800 rounded-2xl flex flex-col gap-1.5">
            ...
            <div className="pt-3 border-t border-gray-800/80 flex flex-col gap-2 mt-2">
              <button 
                ...
                className="w-full py-3 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 rounded-xl font-black text-xs lg:text-sm text-gray-950 flex items-center justify-center gap-1.5 shadow-lg transition-all active:scale-[0.98]"
              >
                <span>公式ノート</span>
                <ArrowRight size={14} />
              </button>
      ...
      {isGuideOpen && (
        <div className="absolute inset-0 bg-black/80 backdrop-blur-md z-[110] flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="w-full max-w-[380px] lg:max-w-md bg-gray-900 border border-gray-800 rounded-3xl p-6 lg:p-8 flex flex-col shadow-2xl relative">
            <button 
            ...
            <div className="text-center mb-6">
              ...
              <h3 className="font-black text-lg lg:text-xl text-white mt-2">🚀 3ステップ作曲ガイド</h3>
            </div>
            ...
            <button 
              onClick={() => setIsGuideOpen(false)}
              className="w-full mt-6 py-3.5 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 rounded-xl font-black text-sm text-white shadow-lg transition-all active:scale-[0.98]"
            >
              作曲をはじめる！
            </button>
          </div>
      ...
      {isListOpen && (
        <div className="absolute inset-0 bg-black/70 backdrop-blur-md z-[100] flex flex-col animate-in fade-in duration-200">
          <div className="w-full max-w-[430px] lg:max-w-md h-[85vh] lg:h-[70vh] my-auto mx-auto bg-gray-900 border border-gray-800 rounded-3xl p-5 lg:p-6 flex flex-col shadow-2xl">
              ...
              {savedMelodies.length === 0 ? (
                ...
                savedMelodies.map((item) => (
                  <div 
                    ...
                    className="p-3.5 bg-gray-950 border border-gray-800/80 rounded-xl flex items-center justify-between gap-3 cursor-pointer transition-all hover:border-teal-500/40"
                  >
